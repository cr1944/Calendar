...
public class LunarDatePicker extends FrameLayout {
    ...
    private static final String LOG_TAG = LunarDatePicker.class.getSimpleName();
    ...
    public interface OnDateChangedListener {
         ...
         */
        void onDateChanged(LunarDatePicker view, int year, int monthOfYear, int dayOfMonth);
    }
    ...
    public LunarDatePicker(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.lunarDatePickerStyle);
    }
    ...
    public LunarDatePicker(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray attributesArray = context.obtainStyledAttributes(attrs, R.styleable.LunarDatePicker,
                defStyle, 0);
        int startYear = attributesArray.getInt(R.styleable.LunarDatePicker_startYear,
                DEFAULT_START_YEAR);
        int endYear = attributesArray.getInt(R.styleable.LunarDatePicker_endYear, DEFAULT_END_YEAR);
        String minDate = attributesArray.getString(R.styleable.LunarDatePicker_minDate);
        String maxDate = attributesArray.getString(R.styleable.LunarDatePicker_maxDate);
        attributesArray.recycle();

        LayoutInflater inflater = (LayoutInflater) context
                .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        inflater.inflate(R.layout.lunar_date_picker, this, true);
        ...
        mDaySpinnerInput = getSpinnerInput(mDaySpinner);
        ...
        mMonthSpinnerInput = getSpinnerInput(mMonthSpinner);
        ...
        mYearSpinnerInput = getSpinnerInput(mYearSpinner);
    ...
    private EditText getSpinnerInput(NumberPicker picker) {
    ...
    /**
     * Sets the maximal date supported by this {@link LunarDatePicker} in
     * milliseconds since January 1, 1970 00:00:00 in
     * {@link TimeZone#getDefault()} time zone.
     *
...
//                R.string.date_picker_decrement_year_button);
    ...
    private static class SavedState extends BaseSavedState {
        ...
        /**
         * Constructor called from {@link LunarDatePicker#onSaveInstanceState()}
         */
